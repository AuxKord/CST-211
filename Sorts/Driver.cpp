...
void Reset(int size, const int set[], int ar[], Array<int> & m_ar, vector<int> & v_ar);
...
//int main(int argc)
{
	...
	ShellSort<Array<int>, int>(mar, size);
	...
	start = high_resolution_clock::now();
	HeapSort<Array<int>, int>(mar, size);
	end = high_resolution_clock::now();
	time = end - start;
	cout << "    Array: "
		<< std::setw(8) << duration_cast<microseconds>(time).count() << (char)230 << "s ";
	...
	start = high_resolution_clock::now();
	MergeSort<Array<int>, int>(mar, size);
	end = high_resolution_clock::now();
	time = end - start;
	cout << "    Array: "
		<< std::setw(8) << duration_cast<microseconds>(time).count() << (char)230 << "s ";
	...
	start = high_resolution_clock::now();
	QuickSort<Array<int>, int>(mar, size);
	end = high_resolution_clock::now();
	time = end - start;
	cout << "    Array: "
		<< std::setw(8) << duration_cast<microseconds>(time).count() << (char)230 << "s ";
	...
	start = high_resolution_clock::now();
	ForceBubble<Array<int>, int>(mar, size);
	end = high_resolution_clock::now();
	time = end - start;
	cout << "    Array: "
		<< std::setw(8) << duration_cast<microseconds>(time).count() << (char)230 << "s ";
	...
	start = high_resolution_clock::now();
	FlaggedBubble<Array<int>, int>(mar, size);
	end = high_resolution_clock::now();
	time = end - start;
	cout << "    Array: "
		<< std::setw(8) << duration_cast<microseconds>(time).count() << (char)230 << "s ";
	...
	start = high_resolution_clock::now();
	SelectionSort<Array<int>, int>(mar, size);
	end = high_resolution_clock::now();
	time = end - start;
	cout << "    Array: "
		<< std::setw(8) << duration_cast<microseconds>(time).count() << (char)230 << "s ";
	...
	start = high_resolution_clock::now();
	InsertionSort<Array<int>, int>(mar, size);
	end = high_resolution_clock::now();
	time = end - start;
	cout << "    Array: "
		<< std::setw(8) << duration_cast<microseconds>(time).count() << (char)230 << "s ";
...
template<typename T>
void SortingDef<T>::BruteForceBubbleSort()
{
	//Native C-Array
	auto start = high_resolution_clock::now();
	Sort<T>::BruteForceBubble<int *, int>(nAr, arSize);
	auto end = high_resolution_clock::now();
	auto time = end - start;

	cout << setw(12) << "ForceBubble:" << "native: "
		<< setw(8) << duration_cast<microseconds>(time).count() << (char)230 << "s ";
	fout << setw(12) << "ForceBubble:" << "native: "
		<< setw(8) << duration_cast<microseconds>(time).count() << (char)230 << "s ";

	//Array Template 
	start = high_resolution_clock::now();
	Sort<T>::BruteForceBubble<Array<int>, int>(cAr, arSize);
	end = high_resolution_clock::now();
	time = end - start;
	...
	//Vector
	start = high_resolution_clock::now();
	Sort<T>::BruteForceBubble<vector<int>, int>(vAr, arSize);
	end = high_resolution_clock::now();
	time = end - start;
	...
	Sort<T>::SetOriginal( nAr, cAr, vAr, arSize, original);
}
